...
const defaults={
 password:"admin123",
 business:{name:"B and A Trading Enterprise",contact:"+27662744119",whatsapp:"+27662744119",address:"Across South Africa",heroTitle:"Professional Accommodation for Power Stations, Mines & Contract Teams",heroText:"Comfortable, reliable accommodation solutions designed for workforces and contractors in demanding environments.",aboutText:"B and A Trading Enterprise provides accommodation solutions for teams working at power stations, mines and contract sites. We focus on comfort, convenience and dependable service.",logo:"",hero:""},
 services:[
...
function render(){
 ...
 $("#galleryGrid").innerHTML=data.gallery.length?data.gallery.map(i=>`<img src="${i}" alt="B and A Trading Enterprise accommodation">`).join(""):`<div class="empty">No gallery pictures yet.</div>`;
